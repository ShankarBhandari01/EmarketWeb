            ...
            <div className="container" style={{ marginTop: "10px" }}>
                <div className="main-body">
                            ...
                            <div className="row gutters-sm">
                                <div className="col-sm-6 mb-3">
                                    <div className="card h-80">
                                        <div className="card-body">
                                            <h2 className="d-flex align-items-center mb-2"> Total Content Sold</h2>
                                ...
                                <div className="col-sm-6 mb-3">
                                    <div className="card h-80">
                                        <div className="card-body">
                                            <h2 className="d-flex align-items-center mb-2"> Total Bought</h2>
                                            <h1 style={{ fontSize: "40px" }}>
                                                1200
                                            </h1>
                                        </div>
                    ...
                    <div className="container" style={{ background: "#E0EFDE" }}>
                        ...
                        <div className="row">
                            <p>View All your bought product</p>
