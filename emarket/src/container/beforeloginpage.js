...
import wallpaper1 from './photo/images/photo1.jpg'
import wallpaper2 from './photo/images/photo2.jpg'
import wallpaper3 from './photo/images/photo3.jpg'
            ...
            <Carousel fade>
                <Carousel.Item style={{ height: "400px" }}>
                    ...
                    <Carousel.Caption>
                        ...
                        <a style={{ backgroundColor: "#a018a0", fontWeight: "bolder", color: "white", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/shopping">Buy veggies</a>
                        <a style={{ backgroundColor: "#51227F", fontWeight: "bolder", color: "white", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/">Explore <FaRocketchat /></a>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item style={{ height: "400px" }}>
                    <img
                    ...
                    <Carousel.Caption>
                        ...
                        <a style={{ backgroundColor: "#a018a0", fontWeight: "bolder", color: "white", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/shopping">Buy Veggies <FaAngellist /></a>
                        <a style={{ backgroundColor: "#51227F", fontWeight: "bolder", color: "white", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/">Explore <FaRocketchat /></a> </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item style={{ height: "400px" }}>
                    <img
                        className="d-block w-100"
                    ...
                    <Carousel.Caption>
                        ...
                        <a style={{ backgroundColor: "#a018a0", fontWeight: "bolder", color: "white", fontWeight: "bold", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/shopping">Buy Now <FaAngellist /></a>
                        <a style={{ backgroundColor: "#51227F", fontWeight: "bolder", color: "white", fontFamily: "roboto" }} class="btn  btn-lg px-4 me-sm-3" href="/">Explore<FaRocketchat /></a>  </Carousel.Caption>
